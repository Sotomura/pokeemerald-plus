...
const u8 gText_LeagueChamp[] = _("Congratulations on becoming\nPokémon League Champion!");
...
const u8 gText_Item[] = _("Held item");
...
const u8 gText_PlayerUsedEscapeRope[] = _("{PLAYER} used the\nEscape Rope.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ShopQuit[] = _("No thanks!");
const u8 gText_SoldOut[] = _("You can't take any more of this item.\p");
const u8 gText_SoldOut2[] = _("---");
...
const u8 gText_Switch2[] = _("Swap Pokémon");
...
const u8 gText_DoWhatWithPokemon[] = _("Do what with {STR_VAR_1}?");
...
const u8 gText_Switch[] = _("Swap Pokémon");
...
const u8 gText_TurnOff[] = _("Log Out");
...
const u8 gText_Challenge[] = _("Battle");
const u8 gText_Info3[] = _("More Info");
...
const u8 gText_LanettesPC[] = _("Bridgette's PC");
...
const u8 gText_MenuOptionPlayer[] = _("TRAINER CARD");
...
const u8 gPCText_Mark[] = _("Markings");
const u8 gPCText_Name[] = _("Change name");
const u8 gPCText_Jump[] = _("Switch Box");
const u8 gPCText_Wallpaper[] = _("Change wallpaper");
...
const u8 gText_MovePokemon[] = _("Organize Boxes");
const u8 gText_MoveItems[] = _("Organize Items");
const u8 gText_SeeYa[] = _("Log Out");
const u8 gText_WithdrawMonDescription[] = _("Add Pokémon from your Boxes to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store Pokémon from your party in\nthe storage system's Boxes.");
const u8 gText_MoveMonDescription[] = _("Organize the Pokémon in your Boxes\nand in your party.");
const u8 gText_MoveItemsDescription[] = _("Organize the items held by Pokémon\nin your Boxes and in your party.");
const u8 gText_SeeYaDescription[] = _("Disconnect from the storage system.");
...
const u8 gText_TrainerCardHoennPokedex[] = _("Hoenn Pokédex");
const u8 gText_TrainerCardNationalPokedex[] = _("National Pokédex");
...
const u8 gJPText_ReceiveMysteryGiftWithEReader[] = _("Receive Mystery Gifts using an e-Reader\nconnected to your Game Boy Advance.");
const u8 gJPText_SelectConnectFromEReaderMenu[] = _("To begin, select “Communication”\nfrom the e-Reader menu.");
const u8 gJPText_SelectConnectWithGBA[] = _("With a GBA Link Cable attached, select\n“To Game Boy Advance” from the menu.");
const u8 gJPText_SelectConnectAndPressA[] = _("Using your e-Reader, select the\n“Communication” option and press A."); // Unused
const u8 gJPText_LinkIsIncorrect[] = _("An incorrect device or application\nhas been linked.");
const u8 gJPText_CardReadingHasBeenHalted[] = _("Cancelled e-Reader card read.");
const u8 gJPText_UnableConnectWithEReader[] = _("カードeリーダー{PLUS}と\nつうしん　できません"); // Unused
const u8 gJPText_Connecting[] = _("Connecting to e-Reader…");
const u8 gJPText_ConnectionErrorCheckLink[] = _("Connection error.\nPlease check the connection.");
const u8 gJPText_ConnectionErrorTryAgain[] = _("Connection error.\nPlease try again."); // Link error
const u8 gJPText_AllowEReaderToLoadCard[] = _("Please scan e-Reader card\ndot code.");
const u8 gJPText_ConnectionComplete[] = _("Connection successful.");
const u8 gJPText_NewTrainerHasComeToHoenn[] = _("A new Trainer has arrived in the\nHoenn region.");
const u8 gJPText_PleaseWaitAMoment[] = _("Please wait.");
const u8 gJPText_WriteErrorUnableToSaveData[] = _("Unable to save game data.");
...
const u8 gText_MenuPlayer[] = _("TRAINER CARD");
...
const u8 gEasyChatGroupName_Move1[] = _("Moves 1");
const u8 gEasyChatGroupName_Move2[] = _("Moves 2");
...
const u8 gText_StevenMatchCallDesc[] = _("Hard as Stone");
